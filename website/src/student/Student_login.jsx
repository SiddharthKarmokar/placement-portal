...
export default function StudentLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (!tokenRes.ok)
        return alert(`❌ ${tokenData.detail || "Login failed"}`);
    ...
    <div className="flex h-screen">
      ...
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M467.006 132.596C583.471 80.0013 685.35 -14.6836 812.005 2.31079C960.633 22.2535 1115.18 93.6589 1181.01 228.4C1246.57 362.608 1189.14 518.749 1131.66 656.612C1079.22 782.362 998.913 894.871 877.418 956.524C755.024 1018.63 617.337 1011.37 482.441 986.056C317.591 955.124 116.62 945.835 36.1559 798.67C-45.1052 650.048 24.3375 458.696 116.336 316.47C190.857 201.265 341.959 189.067 467.006 132.596Z"
          fill="#C89945"
          fill-opacity="0.5"
        />
      </svg>
      ...
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M246.183 -104.329C312.639 -116.256 371.52 -62.0773 418.718 -13.7965C465.269 33.8225 509.63 92.4428 503.35 158.738C497.371 221.846 441.487 266.079 388.857 301.412C346.913 329.57 296.568 327.713 246.183 331.386C189.06 335.551 127.863 356.88 81.0709 323.851C29.1946 287.233 -8.32216 221.457 1.5951 158.738C10.9568 99.5328 85.3425 82.6115 126.158 38.7128C170.216 -8.67467 182.496 -92.898 246.183 -104.329Z"
          fill="#C89945"
        />
      </svg>
    </div>
