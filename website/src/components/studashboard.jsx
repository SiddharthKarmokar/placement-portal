    ...
    projects: [
      {
        ...
        description:
          "Developed a full-stack e-commerce platform with payment gateway integration.",
      },
      {
        title: "Machine Learning Model",
        description:
          "Built a predictive model for customer segmentation using Python and scikit-learn.",
      },
    ],
  });
    ...
    <div className="p-6 font-sans bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md w-full md:w-1/2">
          ...
          <p>
            <strong>Major:</strong> {student.degreeDetails.major}
          </p>
          <p>
          ...
          <p>
            <strong>Expected Passout:</strong>{" "}
            {student.degreeDetails.expectedPassout}
          </p>
          <p>
            <strong>GPA:</strong> {student.degreeDetails.gpa}
          </p>
          <p>
            <strong>CGPA:</strong> {student.degreeDetails.cgpa}
          </p>
        </div>
      </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-md w-full">
          ...
          <div className="flex flex-wrap">
            {student.skills.map((skill, index) => (
              <span
                key={index}
                className="bg-blue-100 text-blue-700 py-1 px-3 rounded-full m-1"
              >
                {skill}
              </span>
            ))}
